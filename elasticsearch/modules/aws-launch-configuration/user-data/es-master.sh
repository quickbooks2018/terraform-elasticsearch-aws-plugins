...
services:
  ...
  elasticsearch:
    build:
      context: .
      dockerfile: MasterNodeDockerfile
    image: es:es
    ...
    container_name: ${CONTAINER_NAME}-${ec2_zone_id}
    hostname: ${CONTAINER_NAME}-${ec2_zone_id}
    restart: unless-stopped
    volumes:
      - /data:/usr/share/elasticsearch/data
# https://www.elastic.co/guide/en/elasticsearch/plugins/7.17/discovery-ec2-usage.html
# https://discuss.elastic.co/t/cant-get-ec2-discovery-working/39604/2
